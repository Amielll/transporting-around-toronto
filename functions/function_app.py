...
@app.function_name(name="OldScheduler")
@app.blob_output(arg_name="outputblob",
                path="stationsblob/station_status_{datetime:yyyyMMddHH}.json",
                connection="AzureWebJobsStorage")
@app.timer_trigger(schedule="0 0 */6 * * *", arg_name="myTimer", run_on_startup=False,
              use_monitor=True) 
def old_scheduler_function(myTimer: func.TimerRequest, outputblob: func.Out[str]) -> None:
