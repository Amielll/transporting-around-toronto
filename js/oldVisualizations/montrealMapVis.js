...
export class MontrealBikeshareMapVis {
    ...
    initVis() {
        ...
        vis.svg.append("text")
            ...
            .text("Montreal Bikeshare Station Volume");
        ...
        vis.stationDots = vis.svg.selectAll("circle.station")
            .data(vis.stationData, d => d["station_id"]);
    ...
    onStationClick(clickedStation) {
        ...
        let filteredTrips = vis.tripData.filter(t => +t["Start Station Name"] === +clickedStation["name"]);
        ...
        let endStations = filteredTrips.map(t => {
            let stationInfo = vis.stationData.find(s => +s["name"] === +t["End Station Name"]);
