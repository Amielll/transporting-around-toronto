...
export class BikeshareMapVis extends BaseMapVis {
    ...
    constructor(parentElement, title, margin, stationData, geoData, DOMInfo, eventHandler) {
        super(parentElement, title, margin, geoData, DOMInfo, eventHandler);
    ...
    initVis() {
        ...
        // const eventName = this.DOMInfo.selectionChangeEventName;
